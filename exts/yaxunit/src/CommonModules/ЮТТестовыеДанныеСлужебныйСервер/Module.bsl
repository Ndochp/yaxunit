		...
		Если Данные.Количество() > 0 Тогда
			...
			Для Каждого Элемент Из Данные Цикл
				Для Каждого КлючЗначение Из Элемент Цикл
					Если ВсеКлючи.Получить(КлючЗначение.Ключ) = Неопределено Тогда
						ВсеКлючи.Вставить(КлючЗначение.Ключ, КлючЗначение.Значение);
					КонецЕсли;
				КонецЦикла;
			КонецЦикла;
			МассивИсточников = Новый Массив();
			МассивИсточников.Добавить(ВсеКлючи);
			Если ОбщиеРеквизиты <> Неопределено Тогда
				МассивИсточников.Добавить(ОбщиеРеквизиты);
			КонецЕсли;
			Для Каждого Источник Из МассивИсточников Цикл
				Для Каждого Элемент Из Источник Цикл
					Если Контейнер.Колонки.Найти(Элемент.Ключ) = Неопределено Тогда
						МассивТипов = ЮТКоллекции.ЗначениеВМассиве(ТипЗнч(Элемент.Значение));
						Контейнер.Колонки.Добавить(Элемент.Ключ, Новый ОписаниеТипов(МассивТипов));
					КонецЕсли;
				КонецЦикла;
			КонецЦикла;
			Если Контейнер.Колонки.Найти("Период") = Неопределено Тогда
				Контейнер.Колонки.Добавить("Период", Новый ОписаниеТипов("Дата", , , Новый КвалификаторыДаты(ЧастиДаты.ДатаВремя)));
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
