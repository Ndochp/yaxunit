...
Функция ЭтоЧисловаяСтрока(Строка) Экспорт
	...
	Для Индекс = 1 По СтрДлина(Строка) Цикл
		...
		ИначеЕсли СтрНайти(ДопустимыеСимволы, Символ) = 0 Тогда
			Возврат Ложь; // Недопустимый символ
		Иначе
			// Символ является цифрой - это допустимо
		КонецЕсли;
	КонецЦикла;
