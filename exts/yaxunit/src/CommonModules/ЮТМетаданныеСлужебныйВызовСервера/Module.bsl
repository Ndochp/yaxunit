...
Функция ОписаниеОбъектаМетаданных(Знач Значение, ЗаполнятьРеквизиты = Истина) Экспорт
	...
	Если ОписаниеТипа.ИмяКоллекции = "РегистрыБухгалтерии" Тогда
		...
		ИмяРеквизитаСчетДт = ?(АнглийскийЯзык, "AccountDr", "СчетДт");
		ИмяРеквизитаСчетКт = ?(АнглийскийЯзык, "AccountCr", "СчетКт");
		ИмяРеквизитаСчет = ?(АнглийскийЯзык, "Account", "Счет");
		ИмяРеквизитаВидСубконто = ?(АнглийскийЯзык, "ExtDimensionType", "ВидСубконто");
		ИмяРеквизитаСубконто = ?(АнглийскийЯзык, "ExtDimension", "Субконто");
		СуффиксДт = ?(АнглийскийЯзык, "Dr", "Дт");
		СуффиксКт = ?(АнглийскийЯзык, "Cr", "Кт");
		ИменаСчетов = Новый Массив();
		Если МетаданныеОбъекта.Корреспонденция Тогда
			
			ИменаСчетов.Добавить(ИмяРеквизитаСчетДт);
			ИменаСчетов.Добавить(ИмяРеквизитаСчетКт);
			...
			Для Каждого Элемент Из ДобавляемыеОписания Цикл
				ОписаниеОбъект.Реквизиты.Вставить(Элемент.Ключ, Элемент.Значение);
			КонецЦикла;
		...
		Иначе
			ИменаСчетов.Добавить(ИмяРеквизитаСчет);
		КонецЕсли;
		...
		Для Каждого Элемент Из ИменаСчетов Цикл
			Реквизит = ЮТМетаданные.ОписаниеРеквизита();
			Реквизит.Имя = Элемент;
			Реквизит.Тип = ОписаниеТипаПланСчета;
			Реквизит.Обязательный = Истина;
			Реквизит.ЭтоКлюч = Истина;
			Реквизит.Стандартный = Истина;
			ОписаниеОбъект.Реквизиты.Вставить(Реквизит.Имя, Реквизит);
		КонецЦикла;
