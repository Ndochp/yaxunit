	...
	ЮТТесты.ВТранзакции()
		.ДобавитьТестовыйНабор("Преобразование значения в строку")
			.ДобавитьТест("ЗначениеВСтроку")
				...
				.СПараметрами(Новый ОписаниеТипов("Дата"), "Новый ОписаниеТипов(""Дата"")")
				.СПараметрами(Новый ОписаниеТипов("Число"), "Новый ОписаниеТипов(""Число"")")
				.СПараметрами(Новый ОписаниеТипов("Строка"), "Новый ОписаниеТипов(""Строка"")")
				.СПараметрами(Новый ОписаниеТипов("Строка, Число, Дата"), "Новый ОписаниеТипов(""Строка, Дата, Число"")")
...
Процедура ЗначениеВСтроку_ОписаниеТиповСКвалификаторами() Экспорт
	...
	ЮТест.ОжидаетЧто(Результат)
		.Равно("Новый ОписаниеТипов(""Строка"", , Новый КвалификаторыСтроки(10, ДопустимаяДлина.Переменная))");
	
	// Тест для строки с фиксированной длиной
	ОписаниеТиповСтрокаПеременная = Новый ОписаниеТипов("Строка", , Новый КвалификаторыСтроки(1, ДопустимаяДлина.Фиксированная));
	Результат = ЮТГенераторКодаСлужебныйСервер.ЗначениеВСтроку(ОписаниеТиповСтрокаПеременная);
	ЮТест.ОжидаетЧто(Результат)
		.Равно("Новый ОписаниеТипов(""Строка"", , Новый КвалификаторыСтроки(1, ДопустимаяДлина.Фиксированная))");
	...
	ЮТест.ОжидаетЧто(Результат)
		.Равно("Новый ОписаниеТипов(""Число"", Новый КвалификаторыЧисла(10, 2, ДопустимыйЗнак.Любой))");
	...
	ЮТест.ОжидаетЧто(Результат)
		.Равно("Новый ОписаниеТипов(""Дата"", , , Новый КвалификаторыДаты(ЧастиДаты.Дата))");
