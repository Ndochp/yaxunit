...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		.ДобавитьТестовыйНабор("ОсновнойНабор")
			...
			.ДобавитьТест("УпалССообщением")
			.ДобавитьТест("УпалБезПараметров")
			.ДобавитьТест("УпалСФактическимИОжидаемымЗначениями")
			.ДобавитьТест("УпалТолькоСФактическимЗначением")
...
Процедура УпалССообщением() Экспорт
	
	Ошибка = ОшибкаУпал("Тест должен упасть с сообщением");
	
	ЮТест.ОжидаетЧто(Ошибка)
		.Заполнено()
		.Свойство("ТипОшибки").Равно(ЮТФабрикаСлужебный.ТипыОшибок().Утверждений)
		.Свойство("Сообщение")
			.Заполнено()
			.Равно("Тест должен упасть с сообщением");
	
КонецПроцедуры

Процедура УпалБезПараметров() Экспорт
...
Процедура УпалСФактическимИОжидаемымЗначениями() Экспорт
	
	Фактическое = 10;
	Ожидаемое = 20;
	
	Ошибка = ОшибкаУпал("Значение не соответствует ожидаемому", Фактическое, Ожидаемое);
	...
	ЮТест.ОжидаетЧто(Ошибка)
		...
		.Свойство("Сообщение")
			.Заполнено()
			.Равно("Значение не соответствует ожидаемому")
		.Свойство("ПроверяемоеЗначение")
			.Заполнено()
			.Содержит("10")
		.Свойство("ОжидаемоеЗначение")
			.Заполнено()
			.Содержит("20");
	
КонецПроцедуры

Процедура УпалТолькоСФактическимЗначением() Экспорт
	
	Фактическое = "Недопустимое значение";
	
	Ошибка = ОшибкаУпал("Получено недопустимое значение", Фактическое);
	...
	ЮТест.ОжидаетЧто(Ошибка)
		...
		.Свойство("Сообщение")
			.Заполнено()
			.Равно("Получено недопустимое значение")
		.Свойство("ПроверяемоеЗначение")
			.Заполнено()
			.Содержит(Фактическое)
		.Свойство("ОжидаемоеЗначение").ЭтоНеопределено();
...
Функция ОшибкаУпал(Сообщение = Неопределено, ФактическоеЗначение = Неопределено, ОжидаемоеЗначение = Неопределено)
