...
7. ✅ Покрытие тестами новой функциональности не менее 80% (26 тестов, 100% пройдено)
...
- ✅ Реализован парсинг дополнительных параметров командной строки
- ✅ Реализована логика слияния параметров с приоритетом
- ✅ Добавлена поддержка относительных путей
