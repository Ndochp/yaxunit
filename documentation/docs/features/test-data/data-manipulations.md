...
* [`ЮТест.Данные().УстановитьФоновуюБлокировку`](/api/ЮТТестовыеДанные#установитьфоновуюблокировку) - Позволяет установить фоновую блокировку данных.
    ...
    ```
* [`ЮТЗапросы`](/api/ЮТЗапросы) - Расширяет возможности тестирования, позволяет в упрощенной форме получать данные из информационной базы как с сервера, так и с клиента.
