...
Создайте **клиентский** модуль в подсистеме `Тесты_ЮТПодключаемыеМодули -> Инициализация`:
...
Создайте **клиентский** модуль в подсистеме `Тесты_ЮТПодключаемыеМодули -> ЗагрузкаТестов`:
