...
> С полным описанием и установкой можно ознакомиться на [сайте плагина](https://bia-technologies.github.io/edt-test-runner/).
...
Кроме конфигурации запуска тестов, плагин добавляет команды запуска тестов для конкретных методов, а также тестовых модулей.  
Справа от имени каждого тестового метода появляется кнопка запуска, запускающая этот тест или все тесты модуля _(если выполнить запуск тестов для метода `ИсполняемыеСценарии`)_.  
