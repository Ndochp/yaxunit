...
`Общий модуль МетодыПлатформы` (название модуля и именование методов-обёрток выбирайте по своему вкусу)
...
Но необходимо определить, где будет выполняться замена на обёртки и придерживаться выбранного подхода:
